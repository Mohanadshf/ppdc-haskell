...
-- tail removes the first char while init removes the last char
------------------------------------------------------------------------------
...
greet first last =
  if last == Nothing
    then "Hello, " ++ first ++ "!"
    else "Hello, " ++ first ++ " " ++ unwrap last ++ "!"
  where
    unwrap (Just s) = s
    unwrap Nothing = ""
-- unwrap takes the value that comes from the maybe result and formalizes it
------------------------------------------------------------------------------
...
--  It uses the normal indexing operator !! to get the element at position i, and wraps it in Just.
------------------------------------------------------------------------------
